            ...
            <div className="card flex-shrink-0 w-full max-w-screen-md shadow-2xl bg-base-100 ">
              ...
              <form onSubmit={handleRegister} className="card-body">
                ...
                <div className="form-control relative">
                  ...
                  />
                  <span
                    className="absolute top-14 right-4 bottom-4 "
                  ...
                  <label className="label">
                    <a
                      href="#"
                      className="label-text-alt text-[#000000] link link-hover"
                    >
                      Forgot password?
                    </a>
                  </label>
              ...
              <p className="text-center py-4 font-medium">
                ...
                <Link
                  className="text-[#000000] font-bold underline hover:text-[#434343]"
                  to="/login"
                >
                  Login
                </Link>
